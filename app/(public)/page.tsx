    ...
    <div className="relative isolate">
      ...
      <div className="relative pt-14">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-cyan-400/30 to-blue-400/30 rounded-full blur-3xl animate-pulse delay-1000" />
          ...
          {/* Floating elements */}
          <div className="absolute inset-0">
            <div className="absolute top-1/4 left-1/4 w-12 h-12 border border-blue-500/30 rounded-lg rotate-12 animate-float" />
            <div className="absolute top-1/3 right-1/3 w-8 h-8 border border-purple-500/30 rounded-full animate-float-delay" />
            <div className="absolute bottom-1/4 right-1/4 w-16 h-16 border border-cyan-500/30 rounded-xl -rotate-12 animate-float" />
          </div>
        ...
        <div className="py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                <h1 className="text-[4.5rem] font-bold tracking-tight bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent sm:text-[5rem] lg:text-[5rem] max-w-[900px] mx-auto leading-[1.1]">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  >
                    <Link
                      href="/register"
                      className="rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 px-8 py-4 text-lg font-semibold text-white shadow-lg hover:shadow-blue-500/30 transition-all duration-300"
                    >
                      Start Free Trial
                    </Link>
                  </motion.div>
                  ...
                  >
                    <Link
                      href="#features"
                      className="rounded-full px-8 py-4 text-lg font-semibold text-gray-900 dark:text-white ring-1 ring-gray-900/10 dark:ring-white/10 hover:ring-gray-900/20 dark:hover:ring-white/20 transition-all duration-300"
                    >
                      See Features
                    </Link>
                  </motion.div>
                  ...
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <img
                        ...
                        alt={`User ${i}`}
                        className="relative w-10 h-10 rounded-full border-2 border-white dark:border-gray-800"
                      />
                    ))}
                  </div>
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative rounded-2xl overflow-hidden bg-gray-900/70 backdrop-blur shadow-2xl ring-1 ring-gray-900/10">
                    <Image
              ...
              <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3">
                ...
                >
                  <dt className="text-base leading-7 text-gray-600 dark:text-gray-400">Average Revenue Increase</dt>
                  <dd className="text-3xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">40%</dd>
                </motion.div>
                <motion.div
                  className="flex flex-col items-center"
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <dt className="text-base leading-7 text-gray-600 dark:text-gray-400">Time Saved on Operations</dt>
                  <dd className="text-3xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">15hrs/week</dd>
                </motion.div>
                <motion.div
                  className="flex flex-col items-center"
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <dt className="text-base leading-7 text-gray-600 dark:text-gray-400">Guest Satisfaction Rate</dt>
                  <dd className="text-3xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">98%</dd>
                </motion.div>
              </div>
            </div>
          </div>
                ...
                {[
                  {
                    ...
                    screenshot: "/images/demo/setup-screenshot.jpg"
                  },
                  {
                    ...
                    screenshot: "/images/demo/manage-screenshot.jpg"
                  },
                  {
                    title: "Grow Revenue",
                    ...
                    screenshot: "/images/demo/revenue-screenshot.jpg"
                  },
                ].map((step, index) => (
                  <motion.div
                    key={step.title}
